...
def convert_to_two_colors(image, colors):
    ...
    mask = image.split()[-1] if image.mode == 'RGBA' else image.point(lambda p: 255 if p > 127 else 0, mode='1')
...
if __name__ == "__main__":
    ...
    output_path = 'pipette_dither_v6.png'  # Change to your desired output file
